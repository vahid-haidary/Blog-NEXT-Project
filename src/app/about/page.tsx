...
function AboutPage() {
  return (
    <div>
        <div className='relative flex w-full h-lvh max-sm:h-[1100px]   '>
            <Image
        ...
        <div className='absolute left-0 right-0 top-10 text-center max-sm:px-5 px-48 text-white select-none'>
            <h1 className='text-5xl font-bold mb-9'>AboutUs</h1>
            <p className='leading-10 font-semibold drop-shadow-sm max-sm:text-sm '>
